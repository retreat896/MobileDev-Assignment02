  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={styles.mono}>No robots found.</Text>
        }
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#2b2b2bff", paddingTop: 60, paddingHorizontal: 16, color:"#ffffff" },
  center: { flex: 1, alignItems: "center", justifyContent: "center", padding: 16 },
  title: { fontSize: 28, fontWeight: "700", marginBottom: 16, color: "#ffffff"},
  card: {
    flexDirection: "row",
    gap: 12,
  ...
  mono: { fontFamily: Platform.select({ ios: "Menlo", android: "monospace" }), marginTop: 8 },
